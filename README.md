...
- [Educative.io](https://www.educative.io/)
    - [What is MERN Stack?](https://www.educative.io/answers/what-is-mern-stack)
- [freeCodeCamp](https://www.freecodecamp.org/)
    - [GraphQL Full Course - Novice to Expert](https://www.youtube.com/watch?v=ed8SzALpx1Q)
    - [Learn React Router in 5 Minutes - A Begginer's Tutorial](https://www.freecodecamp.org/news/react-router-in-5-minutes/)
...
- [FusionAuth](https://fusionauth.io/)
    - [Pros And Cons of JWTs](https://fusionauth.io/articles/tokens/pros-and-cons-of-jwts)
...
- [HyperionDev](https://www.hyperiondev.com/)
    - [Everything You Need to Know about the MERN Stack](https://blog.hyperiondev.com/post/everything-need-know-mern-stack/)
- [JWT.io](https://jwt.io/)
...
- [Prismic.io](https://prismic.io/)
    - [youtube.com/@Prismic](https://www.youtube.com/@Prismic)
    - [3 Things I wish I knew when starting with GraphQL fr Kitze | Prismic](https://www.youtube.com/watch?v=0yr25jzVLMg)
- [React Router](https://reactrouter.com/en/main)
    - [Tutorial](https://reactrouter.com/en/main/start/tutorial)
- [Sebhastian.com](https://sebhastian.com/)
    - [React Router Introduction](https://sebhastian.com/react-router-introduction/)
- [Sitepoint.com](https://www.sitepoint.com/)
    - [React Routerv6: A Beginner's Guide](https://www.sitepoint.com/react-router-complete-guide/)
...
- [WP Rocket](https://wp-rocket.me/)
    - [JSON Web Tokens vs Session Cookies: What's the Difference?](https://wp-rocket.me/blog/difference-json-web-tokens-vs-session-cookies/)
